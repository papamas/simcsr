			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-inbox"></span> Kotak Masuk</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable"   >
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center"><?php echo $value->SenderNumber?></td>
								<td class="center"> <?php echo $value->TextDecoded?></td>
								<td  class="center">
									<span class="label label-success"><?php if($value->readed == true ) echo 'Read'; else echo 'Unread'?></span>
								</td>
